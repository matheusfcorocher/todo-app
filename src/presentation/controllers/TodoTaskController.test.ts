        ...
        describe("When pass todoTasks with", () => {
            describe("at least one is IsCompleted", () => {
                it("returns true", () => {
                    ...
                    const todoTaskController = makeTodoTaskController({ todoTasks, updateTodoTasks: setTodoTasks, localStorage: todoTaskCache });
                    const { isThereAnyTodoTaskCompleted } = todoTaskController;                    
                    const newTodoTasks = isThereAnyTodoTaskCompleted();
        ...
        describe("When pass todoTasks with", () => {
            describe("0 todos tasks", () => {
                it("returns false", () => {
                    ...
                    const todoTaskController = makeTodoTaskController({ todoTasks, updateTodoTasks: setTodoTasks, localStorage: todoTaskCache });
                    const { isTodoTasksNotEmpty } = todoTaskController;                    

                    const answer = isTodoTasksNotEmpty();
        ...
        describe("When pass todoTasks with", () => {
            describe("isCompleted false", () => {
                it("returns only todoTasks with isCompleted false", () => {
                    ...
                    const todoTaskController = makeTodoTaskController({ todoTasks, updateTodoTasks: setTodoTasks, localStorage: todoTaskCache });
                    const { returnOnlyActiveTodoTasks } = todoTaskController;                    

                    const newTodoTasks = returnOnlyActiveTodoTasks();
